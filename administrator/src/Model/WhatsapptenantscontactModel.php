...
/**
 * Whatsapptenantscontact model.
 *
 * @since  1.0.0
 */
class WhatsapptenantscontactModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_dt_whatsapp_tenants_blastings.whatsapptenantscontact';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_dt_whatsapp_tenants_blastings.whatsapptenantscontact', 
								'whatsapptenantscontact',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
								)
	...
	/**
	 * Method to duplicate an Whatsapptenantscontact
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__dt_whatsapp_tenants_contacts');
				$max             = $db->loadResult();
