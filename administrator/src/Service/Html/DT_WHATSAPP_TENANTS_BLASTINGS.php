...
namespace Comdtwhatsapptenantsblastings\Component\Dt_whatsapp_tenants_blastings\Administrator\Service\Html;
...
/**
 * Dt_whatsapp_tenants_blastings HTML Helper.
 *
 * @since  1.0.0
 */
class DT_WHATSAPP_TENANTS_BLASTINGS
{
